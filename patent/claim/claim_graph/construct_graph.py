...
CLAIM_SUPERGRAPH_CLUSTER = int(os.environ.get('CLAIM_SUPERGRAPH_CLUSTER'))
...
def build_graph(super_sapn_file, phrase_embedding_file, output_supergraph_file):
    ...
    for spans in tqdm(super_span, total=TOTAL_NUMBER):
        ...
        if len(graph) > 1:
            cluster_er = hdbscan.HDBSCAN(min_cluster_size=CLAIM_SUPERGRAPH_CLUSTER)
...
if __name__ == '__main__':
    ...
    output_supergraph_file = 'patent/claim/claim_graph/claim_supergraph_list.pkl'
